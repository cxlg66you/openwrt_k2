 ...
 make info
 make image PROFILE=phicomm_psg1218a PACKAGES="uhttpd uhttpd-mod-ubus libiwinfo-lua luci-app-firewall luci-i18n-firewall-zh-cn luci-base luci-mod-admin-full luci-i18n-base-zh-cn firewall luci-theme-material luci-proto-relay relayd wpad-openssl opkg -wpad-basic-wolfssl -ip6tables -odhcp6c -kmod-ipv6 -kmod-ip6tables -odhcpd-ipv6only" CONFIG_IPV6=n
